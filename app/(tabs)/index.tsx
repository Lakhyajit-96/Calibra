    ...
    return (
        <SafeAreaView className="flex-1 bg-background p-5">
                <FlatList
                    ListHeaderComponent={() => (
                        <>
                            ...
                            <View className="home-balance-card">
                                <Text className="home-balance-label">Total Calibration Costs</Text>
                            ...
                            <View className="mb-5">
                                <ListHeading title="Upcoming Calibrations" />
                                ...
                                <FlatList
                                    ...
                                    ListEmptyComponent={<Text className="home-empty-state">No upcoming calibrations yet.</Text>}
                                />
                            </View>

                            <ListHeading title="All Equipment" />
                        </>
                    )}
                    data={subscriptions}
                    keyExtractor={(item) => item.id}
                    ...
                    ListEmptyComponent={<Text className="home-empty-state">No medical equipment yet.</Text>}

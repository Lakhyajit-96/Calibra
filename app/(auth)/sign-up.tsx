                        ...
                        <View className="auth-content">
                            ...
                            <View className="auth-brand-block">
                                <View className="auth-logo-wrap">
                                    ...
                                    <View>
                                        <Text className="auth-wordmark">Calibra</Text>
                                        <Text className="auth-wordmark-sub">CLINIC EQUIPMENT</Text>
                                    </View>
                                </View>
                ...
                >
                    <View className="auth-content">
                        ...
                        <View className="auth-brand-block">
                            ...
                            <Text className="auth-subtitle">
                                Start tracking your medical equipment and never miss a calibration
                            </Text>
                        </View>

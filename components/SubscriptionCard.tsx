            ...
            {expanded && (
                <View className="sub-bdy">
                    <View className="sub-details">
                        ...
                        <View className="sub-row">
                            <View className="sub-row-copy">
                                <Text className="sub-label">Calibration date:</Text>

...
type Category = 'Radiology' | 'Emergency' | 'Aesthetics' | 'Critical Care' | 'Life Support' | 'Other';
const CATEGORIES: Category[] = ['Radiology', 'Emergency', 'Aesthetics', 'Critical Care', 'Life Support', 'Other'];
const CATEGORY_COLORS: Record<Category, string> = {
  'Radiology': '#ff6b6b',
  'Emergency': '#b8d4e3',
  'Aesthetics': '#e8def8',
  'Critical Care': '#f5c542',
  'Life Support': '#95e1d3',
  'Other': '#d4d4d4',
};
        ...
        <Pressable className="modal-overlay" onPress={handleClose}>
          <Pressable className="modal-container" onPress={(e) => e.stopPropagation()}>
            <View className="modal-header">
              <Text className="modal-title">New Equipment</Text>
            ...
            >
              <View className="auth-field">
                <Text className="auth-label">Equipment Name</Text>
                <TextInput
              ...
              <View className="auth-field">
                <Text className="auth-label">Calibration Cost</Text>
                <TextInput
                  className="auth-input"
                  placeholder="0.00"
                  placeholderTextColor="rgba(0, 0, 0, 0.4)"
              ...
              <View className="auth-field">
                <Text className="auth-label">Calibration Interval</Text>
              ...
              <View className="auth-field">
                <Text className="auth-label">Department</Text>
              ...
              >
                <Text className="auth-button-text">Add Equipment</Text>
              </Pressable>
            </ScrollView>
          </Pressable>
        </Pressable>
